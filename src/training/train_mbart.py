"""
Training Script for mBART-50 Model
...
def train_mbart(
    ...
    """
    Train mBART-50 model for legal translation.
    ...
    print("="*80)
    print(f"Training mBART-50 Model")
    print(f"Direction: {direction}")
    print(f"Output: {output_dir}")
    print("="*80)

    # Load tokenizer and model
    print("\nLoading mBART-50 tokenizer and model...")
    ...
    # For bidirectional, we'll handle this in the dataset
    ...
    if direction == 'bidirectional':
        # For bidirectional, we need to alternate between directions
        # We'll use the DirectionalTranslationDataset twice and concatenate
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train mBART-50 for legal translation")
